...
export default function OnlineManipalBbaThankYou({
  subdomain = "onlinemanipalbba",
}: {
  subdomain?: string;
}) {
  return (
    <div className="min-h-screen bg-[#f5f7fb] text-[#17243a] font-sans flex flex-col justify-between selection:bg-[#f7a51c] selection:text-[#111]">
        ...
        <div className="bg-white rounded-[28px] border border-[#e4e8ef] shadow-[0_20px_60px_rgba(16,45,99,0.08)] p-6 sm:p-10 md:p-12 text-center relative overflow-hidden">
          ...
          <p className="text-sm sm:text-base text-[#667085] max-w-xl mx-auto leading-relaxed mb-8">
            ...
            <strong className="text-[#17243a]">
              Online Manipal BBA (Manipal University Jaipur)
            </strong>{" "}
            has been successfully recorded. Our undergraduate counselling team will contact you shortly with syllabus, 10+2 eligibility rules, and low-cost EMI schemes.
          </p>
          ...
          <div className="bg-[#f8fafc] rounded-2xl p-5 sm:p-7 border border-[#e2e7ee] text-left max-w-2xl mx-auto mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h3 className="text-xs sm:text-sm font-bold text-[#102d63]">
                    Undergraduate Admission Guidance
                  </h3>
                  <p className="text-xs text-[#667085] mt-0.5">
                    Connect with an advisor to discuss marketing/finance electives, Coursera access, and ₹3,750/mo monthly installments.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h3 className="text-xs sm:text-sm font-bold text-[#102d63]">
                    10+2 Verification & Admission Confirmation
                  </h3>
                  <p className="text-xs text-[#667085] mt-0.5">
                    Submit digital marksheets for verification to confirm direct university enrolment without entrance exam hurdles.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h3 className="text-xs sm:text-sm font-bold text-[#102d63]">
                    MUJ Digital Campus Activation
                  </h3>
                  <p className="text-xs text-[#667085] mt-0.5">
                    Access digital study materials, e-library, live weekend classes, and free Google/IBM certifications.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5">
            <a
              href="https://wa.me/919266585858?text=Hi%2C%20I%20just%20submitted%20an%20enquiry%20for%20Online%20Manipal%20BBA%20and%20need%20details."
              target="_blank"
      ...
      <footer className="bg-[#0e244d] text-slate-300 py-6 border-t border-white/10 text-center text-xs">
        <div className="w-[min(1160px,92%)] mx-auto">
          © {new Date().getFullYear()} College Vihar & Online Manipal BBA Guidance. All rights reserved.
        </div>
      </footer>
    </div>
  );
